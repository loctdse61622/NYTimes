...
* [x] User canÂ **share an article link**Â to their friends or email it to themselves
* [x] Replaced Filter Settings Activity with a lightweight modal overlay

The following **bonus** features are implemented:

* [x] Use theÂ [RecyclerView](http://guides.codepath.com/android/Using-the-RecyclerView)Â with the `StaggeredGridLayoutManager` to display improve the grid of image results
...
<img src='https://github.com/loctdse61622/NYTimes/blob/master/ny.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
